...
module.exports = {
    ...
    addOneTenant: async (req, res) => {
        ...
        const [newUser] = await db.mgr.mgr_add_one_tenant([first_name, last_name, phone, email, hash, due_date, pet, is_approved, isAdmin, prop_id]).catch(err => console.log(err))
